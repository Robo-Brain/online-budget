...
import com.robo.helloworld.entity.SpendsEntity;
import com.robo.helloworld.entity.SpendsMonthlyEntity;
import com.robo.helloworld.entity.WagesEntity;
...
//  METHODS OF MONTHLY WAGES
    ...
    public void savePaymentTemplate(List<EditTMPSpends> savePaymentTMP) {
        for (EditTMPSpends es : savePaymentTMP) {
    ...
    public void addNewSpendToTemplate(EditTMPSpends editTMPSpends) {
