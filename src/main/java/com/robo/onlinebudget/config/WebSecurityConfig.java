...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/allMonths").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
        http.authorizeRequests().antMatchers("/editTemplate").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
        ...
        http.authorizeRequests().antMatchers("/curMonth").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
